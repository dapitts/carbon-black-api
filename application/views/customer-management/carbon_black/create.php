						...
						<div class="col-md-12">							
							<div class="form-group<?php echo form_error('hostname') ? ' has-error':''; ?>">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control" id="hostname" name="hostname" placeholder="defense.conferdeploy.net" value="<?php echo set_value('hostname'); ?>">
								</div>
							</div>
							<div class="form-group<?php echo form_error('org_key') ? ' has-error':''; ?>">
								...
								<input type="text" class="form-control" id="org_key" name="org_key" placeholder="Enter Organization Key" value="<?php echo set_value('org_key'); ?>">
							</div>
							<div class="form-group<?php echo form_error('api_secret_key') ? ' has-error':''; ?>">
								...
								<input type="text" class="form-control" id="api_secret_key" name="api_secret_key" placeholder="Enter API Secret Key" value="<?php echo set_value('api_secret_key'); ?>">
							</div>
							<div class="form-group<?php echo form_error('api_id') ? ' has-error':''; ?>">
								<label class="control-label" for="api_id">API ID</label>
								<input type="text" class="form-control" id="api_id" name="api_id" placeholder="Enter API ID" value="<?php echo set_value('api_id'); ?>">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12 text-right">
							<button type="submit" class="btn btn-success" data-loading-text="Create...">Create</button>
						</div>
					</div>
	  			</div>
			<?php echo form_close(); ?>			
